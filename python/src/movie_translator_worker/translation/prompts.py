...
def user_prompt_v5(
    *,
    ...
    phase8_note = (
        ...
        "Rows also include sourceProtection.speechAct/questionType/polarity/predicate/numbers/events/certainty/aspect/mustPreserve/naturalizationBudget. Treat these as hard semantic anchors. "
        "Do not change a statement into a question or a why question into a yes/no confirmation question. "
        "Do not copy Chinese modal particles into fixed Vietnamese final particles; only use à/hả/sao/ư/nhỉ/nhé/chứ when source function supports it. "
        "Preserve numbers and units exactly; preserve negation and core predicate before conversational polish. "
        "For low-confidence or ambiguous source, stay close to the literal baseline and avoid invented events, roles, emotions, gender, or relationship details. "
        "Never output translator commentary, options, candidate labels, or 'cần dịch lại' style text.\n"
